...
const PostCard: React.FC<PostCardProps> = ({ user, content, engagement }) => {
  return (
    <Card className="bg-white shadow-sm rounded-sm overflow-hidden border border-gray-200 max-w-2xl mx-auto">
      ...
      <div className="px-4 py-2">
        ...
        {content.image && (
          <div className="overflow-hidden mb-3 border border-gray-200">
            <img src={content.image} alt="Post content" className="w-full h-auto" />
          </div>
        )}
      </div>
      
      <div className="px-4 py-2 border-t flex items-center space-x-2 text-sm">
        ...
        <Button variant="ghost" size="sm" className="text-gray-600 hover:bg-gray-100 flex items-center">
